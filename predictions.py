...
from build_data import build_test_data
...
def create_submission(x_test: np.ndarray, w: np.ndarray,
                      removed_cols: np.ndarray, model: Models, file_name: str) -> None:
    ...
    create_csv_submission(
        ids=test_ids,
        y_pred=pred,
        name=os.path.join(c.OUTPUT_PATH, file_name)
    )