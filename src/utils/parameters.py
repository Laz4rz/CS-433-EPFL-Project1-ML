...
class Parameters:
    ...
    percentage_col: int = c.PERCENTAGE_NAN # Percentage of NaNs to use for dropping columns.
    percentage_row: int = c.PERCENTAGE_NAN # Percentage of NaNs to use for dropping rows.
    fill_nans: str = "with_num"            # How to fill the NaNs (with_num, with_mean, with_num, random)
